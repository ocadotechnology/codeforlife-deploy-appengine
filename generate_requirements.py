...
if args.portal_branch:
    ...
    common_requirement = "git+https://github.com/ocadotechnology/codeforlife-portal.git@553abd7556b6e8bf00622515b3d127e9fe68b859#egg=cfl-common&subdirectory=cfl_common"
else:
