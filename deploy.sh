...
then
    ...
    export DOTMAILER_MAIN_ADDRESS_BOOK_URL=${DOTMAILER_MAIN_ADDRESS_BOOK_URL} >/dev/null 2>&1
    export DOTMAILER_TEACHER_ADDRESS_BOOK_URL=${DOTMAILER_TEACHER_ADDRESS_BOOK_URL} >/dev/null 2>&1
    export DOTMAILER_STUDENT_ADDRESS_BOOK_URL=${DOTMAILER_STUDENT_ADDRESS_BOOK_URL} >/dev/null 2>&1
    export DOTMAILER_NO_ACCOUNT_ADDRESS_BOOK_URL=${DOTMAILER_NO_ACCOUNT_ADDRESS_BOOK_URL} >/dev/null 2>&1
    export DOTMAILER_GET_USER_BY_EMAIL_URL=${DOTMAILER_GET_USER_BY_EMAIL_URL} >/dev/null 2>&1
    export DOTMAILER_DELETE_USER_BY_ID_URL=${DOTMAILER_DELETE_USER_BY_ID_URL} >/dev/null 2>&1
    export DOTMAILER_PUT_CONSENT_DATA_URL=${DOTMAILER_PUT_CONSENT_DATA_URL} >/dev/null 2>&1
    export DOTMAILER_SEND_CAMPAIGN_URL=${DOTMAILER_SEND_CAMPAIGN_URL} >/dev/null 2>&1
    export DOTMAILER_THANKS_FOR_STAYING_CAMPAIGN_ID=${DOTMAILER_THANKS_FOR_STAYING_CAMPAIGN_ID} >/dev/null 2>&1
    ...
    unset DOTMAILER_MAIN_ADDRESS_BOOK_URL >/dev/null 2>&1
    unset DOTMAILER_TEACHER_ADDRESS_BOOK_URL >/dev/null 2>&1
    unset DOTMAILER_STUDENT_ADDRESS_BOOK_URL >/dev/null 2>&1
    unset DOTMAILER_NO_ACCOUNT_ADDRESS_BOOK_URL >/dev/null 2>&1
    unset DOTMAILER_GET_USER_BY_EMAIL_URL >/dev/null 2>&1
    unset DOTMAILER_DELETE_USER_BY_ID_URL >/dev/null 2>&1
    unset DOTMAILER_PUT_CONSENT_DATA_URL >/dev/null 2>&1
    unset DOTMAILER_SEND_CAMPAIGN_URL >/dev/null 2>&1
    unset DOTMAILER_THANKS_FOR_STAYING_CAMPAIGN_ID >/dev/null 2>&1
