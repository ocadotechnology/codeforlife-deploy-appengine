...
export CAPITALIZED_MODULE_NAME="${MODULE_NAME^^}"
MODULE_RECAPTCHA_PUBLIC_KEY_VAR=${MODULE_NAME^^}_DJANGO_RECAPTCHA_PUBLIC_KEY
MODULE_RECAPTCHA_PRIVATE_KEY_VAR=${MODULE_NAME^^}_DJANGO_RECAPTCHA_PRIVATE_KEY
export MODULE_RECAPTCHA_PUBLIC_KEY=${!MODULE_RECAPTCHA_PUBLIC_KEY_VAR}
export MODULE_RECAPTCHA_PRIVATE_KEY=${!MODULE_RECAPTCHA_PRIVATE_KEY_VAR}
